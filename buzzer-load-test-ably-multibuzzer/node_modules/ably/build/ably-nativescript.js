...
})(global, (__WEBPACK_EXTERNAL_MODULE__6015__, __WEBPACK_EXTERNAL_MODULE__3219__) => {
...
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const multicaster_1 = tslib_1.__importDefault(__webpack_require__(572));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const HttpMethods_1 = tslib_1.__importDefault(__webpack_require__(8140));
const HttpStatusCodes_1 = tslib_1.__importDefault(__webpack_require__(7234));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
...
function logAndValidateTokenAuthMethod(authOptions, logger) {
    if (authOptions.authCallback) {
        ...
        throw new errorinfo_1.default(msg, 40106, 401);
    }
}
...
class Auth {
    ...
    async _requestTokenImpl(tokenParams, authOptions) {
            ...
            tokenRequestCallback = (params, cb) => {
                ...
                const authUrlRequestCallback = (result) => {
                    ...
                    if (platform_1.default.BufferUtils.isBuffer(body))
                        body = body.toString();
                    if (!contentType) {
                        const err = new errorinfo_1.default({
                    ...
                    if (!json && !text) {
                        const err = new errorinfo_1.default({
                            message: 'authUrl responded with unacceptable Content-Type ' +
                                contentType +
        ...
        return new Promise((resolve, reject) => {
            let tokenRequestCallbackTimeoutExpired = false, timeoutLength = this.client.options.timeouts.realtimeRequestTimeout, tokenRequestCallbackTimeout = platform_1.default.Config.setTimeout(() => {
                tokenRequestCallbackTimeoutExpired = true;
                const msg = 'Token request via authCallback/authUrl did not complete within the configured timeout (' +
                    timeoutLength / 1000 +
                    ' seconds)';
            ...
            tokenRequestCallback(resolvedTokenParams, (err, tokenRequestOrDetails, contentType) => {
                if (tokenRequestCallbackTimeoutExpired)
                    return;
                platform_1.default.Config.clearTimeout(tokenRequestCallbackTimeout);
                if (err) {
...
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
const auth_1 = tslib_1.__importDefault(__webpack_require__(2742));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const http_1 = __webpack_require__(9428);
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const utils_1 = __webpack_require__(3208);
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(8659));
const basemessage_1 = __webpack_require__(3298);
/**
...
class BaseClient {
    constructor(options) {
        ...
        this._liveObjectsPlugin = (_m = (_l = options.plugins) === null || _l === void 0 ? void 0 : _l.LiveObjects) !== null && _m !== void 0 ? _m : null;
    }
    get rest() {
        if (!this._rest) {
    ...
    get pushConfig() {
        var _a, _b, _c;
        return (_c = (_b = (_a = this.options.plugins) === null || _a === void 0 ? void 0 : _a.Push) === null || _b === void 0 ? void 0 : _b.pushConfig) !== null && _c !== void 0 ? _c : platform_1.default.Config.push;
    }
    /**
     * RSH8
     *
    ...
    device() {
        ...
        if (!this._device) {
            if ((_b = this.pushConfig) === null || _b === void 0 ? void 0 : _b.storageIsAsync) {
                throw new errorinfo_1.default({
    ...
    async getDevice() {
        ...
        if (!this._device) {
            const devicePromise = ((_b = this._devicePromise) !== null && _b !== void 0 ? _b : (this._devicePromise = this.push.LocalDevice.loadAsync(this)));
            try {
    ...
    getTimestampUsingOffset() {
        return platform_1.default.Config.now() + (this.serverTimeOffset || 0);
    }
    isTimeOffsetSet() {
...
const tslib_1 = __webpack_require__(1635);
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const baseclient_1 = tslib_1.__importDefault(__webpack_require__(654));
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(8659));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const connection_1 = tslib_1.__importDefault(__webpack_require__(624));
const realtimechannel_1 = tslib_1.__importDefault(__webpack_require__(9734));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const TransportName_1 = __webpack_require__(5868);
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
/**
...
class Channels extends eventemitter_1.default {
    ...
    release(name) {
        name = String(name);
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MAJOR, 'Channels.release()', 'Releasing references to channel ' + name);
        const channel = this.all[name];
        if (!channel) {
            return;
        }
        ...
        channel
            .detach()
            .catch((err) => {
            logger_1.default.logAction(this.logger, logger_1.default.LOG_ERROR, 'Channels.release()', 'Error detaching channel ' + name + ' prior to release: ' + Utils.inspectError(err));
        })
            .then(() => {
            delete this.all[name];
        });
...
const tslib_1 = __webpack_require__(1635);
const baseclient_1 = tslib_1.__importDefault(__webpack_require__(654));
const rest_1 = __webpack_require__(3758);
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
/**
...
const tslib_1 = __webpack_require__(1635);
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(8659));
const connectionmanager_1 = tslib_1.__importDefault(__webpack_require__(1237));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
...
const tslib_1 = __webpack_require__(1635);
const baserealtime_1 = tslib_1.__importDefault(__webpack_require__(3004));
const modularplugins_1 = __webpack_require__(9470);
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const connectionmanager_1 = tslib_1.__importDefault(__webpack_require__(1237));
const protocolmessage_1 = tslib_1.__importDefault(__webpack_require__(9809));
const defaultmessage_1 = __webpack_require__(5200);
const realtimepresence_1 = tslib_1.__importDefault(__webpack_require__(848));
const defaultpresencemessage_1 = __webpack_require__(1583);
const defaultannotation_1 = __webpack_require__(1282);
const websockettransport_1 = tslib_1.__importDefault(__webpack_require__(7760));
const filteredsubscriptions_1 = __webpack_require__(7113);
const presencemap_1 = __webpack_require__(3075);
const presencemessage_1 = tslib_1.__importStar(__webpack_require__(2318));
const realtimeannotations_1 = tslib_1.__importDefault(__webpack_require__(8679));
const restannotations_1 = tslib_1.__importDefault(__webpack_require__(334));
const annotation_1 = tslib_1.__importStar(__webpack_require__(3837));
const http_1 = __webpack_require__(9428);
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const basemessage_1 = __webpack_require__(3298);
...
const tslib_1 = __webpack_require__(1635);
const baserest_1 = __webpack_require__(6767);
const modularplugins_1 = __webpack_require__(9470);
const defaultmessage_1 = __webpack_require__(5200);
const defaultpresencemessage_1 = __webpack_require__(1583);
const defaultannotation_1 = __webpack_require__(1282);
...
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const resource_1 = tslib_1.__importDefault(__webpack_require__(8236));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const HttpStatusCodes_1 = tslib_1.__importDefault(__webpack_require__(7234));
...
class HttpPaginatedResponse extends PaginatedResult {
    constructor(resource, items, headers, statusCode, relParams, err) {
        ...
        this.errorDetail = err === null || err === void 0 ? void 0 : err.detail;
    }
    toJSON() {
        return {
            items: this.items,
...
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(8659));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const presencemessage_1 = tslib_1.__importDefault(__webpack_require__(2318));
...
class PresenceMap extends eventemitter_1.default {
    ...
    startSync() {
        ...
        this.residualMembers = Object.create(null);
...
const tslib_1 = __webpack_require__(1635);
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const devicedetails_1 = tslib_1.__importDefault(__webpack_require__(6798));
const resource_1 = tslib_1.__importDefault(__webpack_require__(8236));
const paginatedresource_1 = tslib_1.__importDefault(__webpack_require__(2821));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const pushchannelsubscription_1 = tslib_1.__importDefault(__webpack_require__(6840));
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
...
const PUSH_ACTIVATION_NOT_AVAILABLE_HINT = 'Run push.activate() in a browser environment with service worker support, or in React Native using the ably/react-native-push plugin. From a server, use client.push.admin instead. Call client.push.admin.publish(recipient, payload) to send to a device or clientId. Call client.push.admin.deviceRegistrations.save(device) to register a device record.';
const PUSH_DEACTIVATION_NOT_AVAILABLE_HINT = 'Run push.deactivate() in a browser environment with service worker support, or in React Native using the ably/react-native-push plugin. From a server, call client.push.admin.deviceRegistrations.remove(deviceId) to remove a device registration.';
const PUSH_TOKEN_UPDATE_NOT_AVAILABLE_HINT = 'Call push.updateToken() in React Native with the ably/react-native-push plugin configured, passing plugins: { Push: ReactNativePush.create({ storage, requestToken }) } in the client options. From a server, use client.push.admin.deviceRegistrations.save(device) to modify a device registration instead.';
class Push {
    constructor(client) {
        var _a;
        this.client = client;
        this.admin = new Admin(client);
        const pushPlugin = (_a = client.options.plugins) === null || _a === void 0 ? void 0 : _a.Push;
        ...
        if (client.pushConfig && pushPlugin) {
            ...
            this.LocalDevice = pushPlugin.localDeviceFactory(devicedetails_1.default);
        }
    }
    async activate(registerCallback, updateFailedCallback) {
        var _a;
        const pushPlugin = (_a = this.client.options.plugins) === null || _a === void 0 ? void 0 : _a.Push;
        if (!pushPlugin) {
...
class Admin {
    ...
    async createApnsBroadcast(options) {
        ...
        const format = client.options.useBinaryProtocol ? Utils.Format.msgpack : Utils.Format.json, headers = defaults_1.default.defaultPostHeaders(client.options), params = {};
        Utils.mixin(headers, client.options.headers);
        const requestBody = Utils.encodeBody({ messageStoragePolicy: options.messageStoragePolicy }, client._MsgPack, format);
        const response = await resource_1.default.post(client, '/push/apnsBroadcastChannels', requestBody, headers, params, null, true);
        return (response.unpacked ? response.body : Utils.decodeBody(response.body, client._MsgPack, format));
    }
}
class LiveActivity {
    constructor(client) {
    ...
    async start(params) {
        ...
        if (hasChannels === hasDeviceId) {
            throw new errorinfo_1.default('LiveActivity.start() requires exactly one of recipient.channels or recipient.deviceId', 40000, 400);
        }
        const body = { apns };
        if (hasChannels) {
    ...
    async _post(apnsBroadcast, action, body) {
        ...
        const requestHeaders = defaults_1.default.defaultPostHeaders(client.options);
        const params = {};
        Utils.mixin(requestHeaders, client.options.headers);
        const requestBody = Utils.encodeBody(body, client._MsgPack, format);
        await resource_1.default.post(client, '/push/apnsBroadcastChannels/' + encodeURIComponent(apnsBroadcast) + '/' + action, requestBody, requestHeaders, params, null, true);
    }
}
...
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(8659));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const protocolmessagecommon_1 = __webpack_require__(8512);
const protocolmessage_1 = __webpack_require__(9809);
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const realtimechannel_1 = tslib_1.__importDefault(__webpack_require__(9734));
const restannotations_1 = tslib_1.__importStar(__webpack_require__(334));
class RealtimeAnnotations {
    ...
    async publish(msgOrSerial, annotationValues) {
        ...
        const annotation = (0, restannotations_1.constructValidateAnnotation)(msgOrSerial, annotationValues, 'publish');
    ...
    async subscribe(..._args /* [type], listener */) {
        ...
        if (this.channel.state === 'attached' && (this.channel._mode & protocolmessagecommon_1.flags.ANNOTATION_SUBSCRIBE) === 0) {
            ...
            logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_MAJOR, 'RealtimeAnnotations.subscribe()', err.message + '; remediation=' + err.remediation);
...
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const basemessage_1 = __webpack_require__(3298);
const message_1 = tslib_1.__importStar(__webpack_require__(6041));
const channelstatechange_1 = tslib_1.__importDefault(__webpack_require__(5968));
const errorinfo_1 = tslib_1.__importStar(__webpack_require__(9612));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const defaults_1 = __webpack_require__(4567);
        ...
        for (let i = 0; i < options.modes.length; i++) {
            ...
            if (!currentMode ||
                ...
                const err = new errorinfo_1.default({
                    ...
                    code: 40000,
                    statusCode: 400,
                    remediation: `Valid ChannelMode values are: ${protocolmessagecommon_1.channelModes.join(', ').toLowerCase()}. The server grants only the modes the key or token capability permits and silently drops the rest on attach. After attach, channel.modes shows what was granted. If you have the Ably CLI installed, \`ably auth keys list\` shows your key's capabilities.`,
                });
                return err;
            }
        }
...
class RealtimeChannel extends eventemitter_1.default {
    ...
    constructor(client, name, options) {
        ...
        this._attachedReceived = new eventemitter_1.default(this.logger);
        this.internalStateChanges = new eventemitter_1.default(this.logger);
    ...
    async _publishImpl(args) {
        ...
        const pm = (0, protocolmessage_1.fromValues)({
            action: protocolmessagecommon_1.actions.MESSAGE,
            channel: this.name,
    ...
    async _subscribeImpl(args) {
        ...
        if (this.state === 'attached' && (this._mode & protocolmessagecommon_1.flags.SUBSCRIBE) === 0) {
            const err = new errorinfo_1.default({
            ...
            if (!this._silentSubscribeWarned) {
                logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_ERROR, 'RealtimeChannel.subscribe()', err.message + '; remediation=' + err.remediation + logger_1.default.silentFailureLogSuffix());
    ...
    sync() {
        ...
        switch (this.state) {
            ...
            case 'detached': {
                ...
                throw new errorinfo_1.PartialErrorInfo({
    ...
    requeuePresenceFromConnectionQueue(pendingMessage) {
        ...
        if (this._presence && (this.state === 'attached' || this.state === 'attaching' || this.state === 'suspended')) {
            ...
            this._presence.requeuePresenceMessages((_a = pendingMessage.message.presence) !== null && _a !== void 0 ? _a : [], (err) => callback === null || callback === void 0 ? void 0 : callback(err));
            return true;
        }
        return false;
    }
    ...
    startStateTimerIfNotRunning() {
        if (!this.stateTimer) {
            this.stateTimer = platform_1.default.Config.setTimeout(() => {
    ...
    clearStateTimer() {
        ...
        if (stateTimer) {
            platform_1.default.Config.clearTimeout(stateTimer);
            this.stateTimer = null;
        }
    }
    startRetryTimer() {
        ...
        this.retryTimer = platform_1.default.Config.setTimeout(() => {
    ...
    cancelRetryTimer() {
        if (this.retryTimer) {
            platform_1.default.Config.clearTimeout(this.retryTimer);
            this.retryTimer = null;
        }
    }
    ...
    getReleaseErr() {
        ...
        const err = new errorinfo_1.default({
            message: 'Can only release a channel in a state where there is no possibility of further updates from the server being received (initialized, detached, or failed). The current state is ' +
                s,
            code: 90001,
            statusCode: 400,
    ...
    async appendMessage(message, operation, params) {
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'RealtimeChannel.appendMessage()', 'channel = ' + this.name);
    ...
    async sendUpdate(message, action, operation, params) {
        ...
        this.throwIfUnpublishableState();
        const updateDeleteMsg = message_1.default.fromValues(Object.assign(Object.assign({}, message), { action: action, version: operation }));
        ...
        return { versionSerial: (_a = publishResponse.serials[0]) !== null && _a !== void 0 ? _a : null };
    }
...
class RealtimePresence extends eventemitter_1.default {
    ...
    async _getImpl(params) {
        ...
        if ((this.channel._mode & protocolmessagecommon_1.flags.PRESENCE_SUBSCRIBE) === 0) {
            const err = new errorinfo_1.default({
            ...
            if (this.channel.client.options.strictMode === true)
                throw err;
            logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_ERROR, 'RealtimePresence.get()', err.message + '; remediation=' + err.remediation + logger_1.default.silentFailureLogSuffix());
        }
    ...
    _ensureMyMembersPresent() {
        ...
        for (const memberKey in myMembers.map) {
            ...
            this._enterOrUpdateClient(id, entry.clientId, entry.data, 'enter').catch((err) => {
                const wrappedErr = new errorinfo_1.default({
    ...
    _synthesizeLeaves(items) {
        ...
        items.forEach(function (item) {
            const presence = presencemessage_1.default.fromValues({
                ...
                timestamp: platform_1.default.Config.now(),
            });
            subscriptions.emit('leave', presence);
        });
    }
    subscribe(..._args /* [event], listener */) {
...
const auth_1 = tslib_1.__importDefault(__webpack_require__(2742));
const HttpMethods_1 = tslib_1.__importDefault(__webpack_require__(8140));
const errorinfo_1 = __webpack_require__(9612);
const http_1 = __webpack_require__(9428);
const HttpStatusCodes_1 = tslib_1.__importDefault(__webpack_require__(7234));
...
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
const push_1 = tslib_1.__importDefault(__webpack_require__(2564));
const paginatedresource_1 = tslib_1.__importDefault(__webpack_require__(2821));
const restchannel_1 = tslib_1.__importDefault(__webpack_require__(5487));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const stats_1 = tslib_1.__importDefault(__webpack_require__(5601));
const HttpMethods_1 = tslib_1.__importDefault(__webpack_require__(8140));
const resource_1 = tslib_1.__importDefault(__webpack_require__(8236));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const auth_1 = __webpack_require__(2742);
const restchannelmixin_1 = __webpack_require__(6934);
const restpresencemixin_1 = __webpack_require__(7974);
const devicedetails_1 = tslib_1.__importDefault(__webpack_require__(6798));
const pushchannelsubscription_1 = tslib_1.__importDefault(__webpack_require__(6840));
class Rest {
    constructor(client) {
    ...
    async time(params) {
        ...
        this.client.serverTimeOffset = time - platform_1.default.Config.now();
        return time;
    }
    async request(method, path, version, params, body, customHeaders) {
        var _a;
        ...
        if (!platform_1.default.Http.methods.includes(_method)) {
            throw new errorinfo_1.default({
                ...
                code: 40500,
                statusCode: 405,
                remediation: `Use one of: ${platform_1.default.Http.methods.join(', ')}.`,
            });
        }
...
const resource_1 = tslib_1.__importDefault(__webpack_require__(8236));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
function serialFromMsgOrSerial(msgOrSerial, methodName) {
    let messageSerial;
    ...
    if (!messageSerial || typeof messageSerial !== 'string') {
        throw new errorinfo_1.default({
            message: 'The message argument of annotations.' +
                methodName +
...
function constructValidateAnnotation(msgOrSerial, annotationValues, methodName) {
    const messageSerial = serialFromMsgOrSerial(msgOrSerial, methodName);
    if (!annotationValues || typeof annotationValues !== 'object') {
        throw new errorinfo_1.default({
            message: 'Second argument of annotations.' + methodName + '() must be an object (the intended annotation to publish)',
            code: 40003,
            statusCode: 400,
...
class RestAnnotations {
    ...
    async _publish(msgOrSerial, annotationValues, methodName) {
    ...
    async get(msgOrSerial, params) {
        const client = this.channel.client, messageSerial = serialFromMsgOrSerial(msgOrSerial, 'get'), format = client.options.useBinaryProtocol ? Utils.Format.msgpack : Utils.Format.json, envelope = client.http.supportsLinkHeaders ? undefined : format, headers = defaults_1.default.defaultGetHeaders(client.options);
        Utils.mixin(headers, client.options.headers);
...
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const restpresence_1 = tslib_1.__importDefault(__webpack_require__(2719));
const message_1 = tslib_1.__importStar(__webpack_require__(6041));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const resource_1 = tslib_1.__importDefault(__webpack_require__(8236));
const defaults_1 = tslib_1.__importStar(__webpack_require__(4567));
...
class RestChannel {
    ...
    async history(params) {
        ...
        return this.client.rest.channelMixin.history(this, params !== null && params !== void 0 ? params : null);
    }
    async publish(...args) {
        const first = args[0], second = args[1];
        let messages;
        ...
        return this._publish((0, message_1.serialize)(wireMessages, client._MsgPack, format), headers, params);
    }
    async _publish(requestBody, headers, params) {
        const client = this.client;
        const format = client.options.useBinaryProtocol ? Utils.Format.msgpack : Utils.Format.json;
        const { body, unpacked } = await resource_1.default.post(client, client.rest.channelMixin.basePath(this) + '/messages', requestBody, headers, params, null, true);
        const decoded = (unpacked ? body : Utils.decodeBody(body, client._MsgPack, format)) ||
            {};
    ...
    async appendMessage(message, operation, params) {
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'RestChannel.appendMessage()', 'channel = ' + this.name);
...
class RestChannelMixin {
    ...
    static async updateDeleteMessage(channel, action, message, operation, params) {
        ...
        const requestMessage = message_1.default.fromValues(message);
        ...
        const requestBody = (0, message_1.serialize)(encoded, client._MsgPack, format);
        let method = resource_1.default.patch;
...
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const paginatedresource_1 = tslib_1.__importDefault(__webpack_require__(2821));
const presencemessage_1 = __webpack_require__(2318);
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
class RestPresence {
    constructor(channel) {
        this.channel = channel;
...
const protocolmessagecommon_1 = __webpack_require__(8512);
const protocolmessage_1 = __webpack_require__(9809);
const transport_1 = tslib_1.__importDefault(__webpack_require__(8783));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const defaults_1 = tslib_1.__importDefault(__webpack_require__(4567));
const connectionerrors_1 = tslib_1.__importDefault(__webpack_require__(8167));
const auth_1 = tslib_1.__importDefault(__webpack_require__(2742));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const XHRStates_1 = tslib_1.__importDefault(__webpack_require__(8266));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
...
const protocolmessage_1 = __webpack_require__(9809);
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const protocol_1 = tslib_1.__importStar(__webpack_require__(4880));
const defaults_1 = tslib_1.__importStar(__webpack_require__(4567));
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(8659));
const messagequeue_1 = tslib_1.__importDefault(__webpack_require__(1726));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const connectionstatechange_1 = tslib_1.__importDefault(__webpack_require__(6423));
const connectionerrors_1 = tslib_1.__importStar(__webpack_require__(8167));
const errorinfo_1 = tslib_1.__importStar(__webpack_require__(9612));
const auth_1 = tslib_1.__importDefault(__webpack_require__(2742));
const transport_1 = tslib_1.__importDefault(__webpack_require__(8783));
const HttpStatusCodes_1 = tslib_1.__importDefault(__webpack_require__(7234));
...
class ConnectionManager extends eventemitter_1.default {
        ...
        if (haveSessionStorage()) {
            ...
            if (recoveryKey) {
                this.setSessionRecoverData({
                    ...
                    disconnectedAt: platform_1.default.Config.now(),
    ...
    startTransitionTimer(transitionState) {
        ...
        if (this.transitionTimer) {
            ...
            platform_1.default.Config.clearTimeout(this.transitionTimer);
        }
        this.transitionTimer = platform_1.default.Config.setTimeout(() => {
            if (this.transitionTimer) {
    ...
    startSuspendTimer() {
        if (this.suspendTimer)
            return;
        this.suspendTimer = platform_1.default.Config.setTimeout(() => {
            if (this.suspendTimer) {
    ...
    cancelSuspendTimer() {
        ...
        if (this.suspendTimer) {
            platform_1.default.Config.clearTimeout(this.suspendTimer);
            this.suspendTimer = null;
        }
    }
    ...
    startWebSocketSlowTimer() {
        this.webSocketSlowTimer = platform_1.default.Config.setTimeout(() => {
    ...
    cancelWebSocketSlowTimer() {
        if (this.webSocketSlowTimer) {
            platform_1.default.Config.clearTimeout(this.webSocketSlowTimer);
            this.webSocketSlowTimer = null;
        }
    }
    startWebSocketGiveUpTimer(transportParams) {
        this.webSocketGiveUpTimer = platform_1.default.Config.setTimeout(() => {
            if (!this.wsCheckResult) {
                if (this.baseTransport) {
                    logger_1.default.logAction(this.logger, logger_1.default.LOG_MINOR, 'ConnectionManager WebSocket give up timer', 'websocket connection took more than ' + this.options.timeouts.webSocketConnectTimeout + 'ms');
    ...
    cancelWebSocketGiveUpTimer() {
        if (this.webSocketGiveUpTimer) {
            platform_1.default.Config.clearTimeout(this.webSocketGiveUpTimer);
            this.webSocketGiveUpTimer = null;
        }
    }
        ...
        if (retryImmediately) {
            const autoReconnect = () => {
                if (this.state === this.states.disconnected) {
                    this.lastAutoReconnectAttempt = platform_1.default.Config.now();
                    this.requestState({ state: 'connecting' });
                }
            };
            const sinceLast = this.lastAutoReconnectAttempt && platform_1.default.Config.now() - this.lastAutoReconnectAttempt + 1;
            if (sinceLast && sinceLast < 1000) {
                ...
                platform_1.default.Config.setTimeout(autoReconnect, 1000 - sinceLast);
            }
            else {
    ...
    abandonWebSocketForBaseTransport(transportParams) {
        var _a, _b;
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MINOR, 'ConnectionManager.abandonWebSocketForBaseTransport()', 'websocket connectivity appears to be unavailable; trying base transport');
     ...
     */
    checkWsAvailabilityBeforeGivingUp(transportParams, connectCount, giveUp) {
    ...
    queuedPresenceToChannelQueues() {
        this.queuedMessages.messages = this.queuedMessages.messages.filter((pendingMessage) => {
            if (pendingMessage.message.action !== protocolmessagecommon_1.actions.PRESENCE) {
                return true;
            }
    ...
    actOnErrorFromAuthorize(err) {
        if (err.code === 40171) {
            ...
            const wrapped = new errorinfo_1.default({
                message: msg,
                code: 80019,
                statusCode: 403,
                cause: err,
            ...
            this.notifyState({ state: this.state.failState, error: wrapped });
        }
    }
...
class MessageQueue extends eventemitter_1.default {
    ...
    completeMessages(selector, err, res) {
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'MessageQueue.completeMessages()', selector == 'all' ? '(all)' : 'serial = ' + selector.serial + '; count = ' + selector.count);
        err = err || null;
        ...
        if (selector === 'all') {
            ...
            if (first) {
                ...
                const endSerial = selector.serial + selector.count; /* the serial of the first message that is *not* the subject of this call */
        ...
        for (let i = 0; i < completeMessages.length; i++) {
            ...
            const publishResponse = res === null || res === void 0 ? void 0 : res[i];
...
class Transport extends eventemitter_1.default {
    ...
    finish(event, err) {
        ...
        this.isConnected = false;
        this.maxIdleInterval = null;
        platform_1.default.Config.clearTimeout(((_a = this.idleTimer) !== null && _a !== void 0 ? _a : undefined));
        this.idleTimer = null;
        this.emit(event, err);
        this.dispose();
    }
    ...
    onActivity() {
        ...
        this.lastActivity = platform_1.default.Config.now();
        this.setIdleTimer(this.maxIdleInterval + 100);
    }
    setIdleTimer(timeout) {
        if (!this.idleTimer) {
            this.idleTimer = platform_1.default.Config.setTimeout(() => {
    ...
    onIdleTimerExpire() {
        ...
        this.idleTimer = null;
        const sinceLast = platform_1.default.Config.now() - this.lastActivity;
    ...
    static tryConnect(transportCtor, connectionManager, auth, transportParams, callback) {
        ...
        const errorCb = function (err) {
            platform_1.default.Config.clearTimeout(transportAttemptTimer);
            callback({ event: this.event, error: err });
        };
        const realtimeRequestTimeout = connectionManager.options.timeouts.realtimeRequestTimeout;
        transportAttemptTimer = platform_1.default.Config.setTimeout(() => {
...
__webpack_unused_export__ = ({ value: true });
exports.BaseMessage = exports.strMsg = exports.populateFieldsFromParent = exports.MessageEncoding = __webpack_unused_export__ = exports.wireToJSON = __webpack_unused_export__ = exports.decode = __webpack_unused_export__ = exports.encode = __webpack_unused_export__ = exports.normalizeCipherOptions = void 0;
const tslib_1 = __webpack_require__(1635);
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
...
__webpack_unused_export__ = encryptData;
/**
...
__webpack_unused_export__ = encodeData;
...
async function decodeData(data, encoding, inputContext) {
    ...
    if (encoding) {
        ...
        try {
            ...
            const err = e;
            decodingError = new errorinfo_1.default({
...
__webpack_unused_export__ = decodeData;
...
__webpack_unused_export__ = encodeDataForWire;
...
function toString(err) {
    ...
    if (err.remediation)
        result += '; remediation=' + err.remediation;
    ...
    constructor(messageOrValues, code, statusCode, cause, detail) {
        if (typeof messageOrValues === 'object') {
            ...
            if (typeof values.message !== 'string' ||
                ...
                throw new Error('ErrorInfo: invalid values: ' + platform_1.default.Config.inspect(values));
            }
    ...
    constructor(messageOrValues, code, statusCode, cause, detail) {
        if (typeof messageOrValues === 'object') {
            ...
            if (typeof values.message !== 'string' ||
                ...
                (!Utils.isNil(values.detail) && (typeof values.detail !== 'object' || Array.isArray(values.detail)))) {
                throw new Error('PartialErrorInfo: invalid values: ' + platform_1.default.Config.inspect(values));
            }
            super(values.message);
            if (typeof Object.setPrototypeOf !== 'undefined') {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WireMessage = exports.getMessagesSize = exports.serialize = exports.encodeArray = exports._fromEncodedArray = exports._fromEncoded = exports.fromEncodedArray = exports.fromEncoded = exports.encodeAction = exports.stringifyAction = void 0;
const tslib_1 = __webpack_require__(1635);
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const basemessage_1 = __webpack_require__(3298);
const Utils = tslib_1.__importStar(__webpack_require__(3208));
...
const Utils = tslib_1.__importStar(__webpack_require__(3208));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const message_1 = __webpack_require__(6041);
const presencemessage_1 = tslib_1.__importStar(__webpack_require__(2318));
const annotation_1 = tslib_1.__importStar(__webpack_require__(3837));
const realtimeannotations_1 = tslib_1.__importDefault(__webpack_require__(8679));
const restannotations_1 = tslib_1.__importDefault(__webpack_require__(334));
...
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const package_json_1 = __webpack_require__(8330);
...
function getHandler(logger) {
    return platform_1.default.Config.logTimestamps
        ? function (msg) {
            const time = new Date(platform_1.default.Config.now());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.listenerToAsyncIterator = exports.withTimeoutAsync = exports.throwMissingPluginError = exports.createMissingPluginError = exports.arrEquals = exports.toBase64 = exports.matchDerivedChannel = exports.shallowEquals = exports.getGlobalObject = exports.getRetryTime = exports.getJitterCoefficient = exports.getBackoffCoefficient = exports.allToUpperCase = exports.allToLowerCase = exports.encodeBody = exports.decodeBody = exports.whenPromiseSettles = exports.arrChooseN = exports.randomString = exports.cheapRandStr = exports.dataSizeBytes = exports.inspectBody = exports.inspectError = exports.detectV1Callback = exports.isErrorInfoOrPartialErrorInfo = exports.parseQueryString = exports.stringifyValues = exports.toQueryString = exports.arrPopRandomElement = exports.Format = exports.allSame = exports.forInOwnNonNullProperties = exports.valuesArray = exports.keysArray = exports.arrWithoutValue = exports.arrDeleteValue = exports.arrIntersectOb = exports.arrIntersect = exports.intersect = exports.containsValue = exports.inherits = exports.prototypicalClone = exports.shallowClone = exports.isNil = exports.isEmpty = exports.isObject = exports.ensureArray = exports.copy = exports.mixin = void 0;
const tslib_1 = __webpack_require__(1635);
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const errorinfo_1 = tslib_1.__importStar(__webpack_require__(9612));
...
function detectV1Callback(args, v2TrailingFnArity) {
    ...
    if (typeof args[n - 1] !== 'function')
        return;
    if (n <= v2TrailingFnArity && typeof args[n - 2] !== 'function')
        return;
    throw new errorinfo_1.default({
        message: 'v1 callback signature is no longer supported: v2 methods return a promise.',
        code: 40025,
        statusCode: 400,
        remediation: 'Drop the trailing callback and `await` the returned promise. ' +
            'See https://github.com/ably/ably-js/blob/main/docs/migration-guides/v2/lib.md.',
    });
}
exports.detectV1Callback = detectV1Callback;
...
function matchDerivedChannel(name) {
    ...
    if (!match || !match.length || match.length < 5) {
        throw new errorinfo_1.default({
            ...
            code: 40010,
            statusCode: 400,
            remediation: 'Pass a non-empty channel name to channels.getDerived(name, { filter: ... }) and put the filter expression in the filter option, not in the name. ' +
...
async function withTimeoutAsync(promise, timeout = 5000, err = 'Timeout expired') {
    ...
    return Promise.race([
        promise,
        new Promise((_resolve, reject) => platform_1.default.Config.setTimeout(() => reject(e), timeout)),
    ]);
}
...
class Http {
    ...
    async do(method, path, headers, body, params) {
        try {
            ...
            if (currentFallback) {
                if (currentFallback.validUntil > platform_1.default.Config.now()) {
                    /* Use stored fallback */
            ...
            const tryAHost = async (candidateHosts, persistOnSuccess) => {
                const host = candidateHosts.shift();
                tryAHostStartedAt = tryAHostStartedAt !== null && tryAHostStartedAt !== void 0 ? tryAHostStartedAt : platform_1.default.Config.now();
                ...
                if (result.error && this.platformHttp.shouldFallback(result.error) && candidateHosts.length) {
                    // TO3l6
                    const elapsedTime = platform_1.default.Config.now() - tryAHostStartedAt;
                ...
                if (persistOnSuccess) {
                    ...
                    client._currentFallback = {
                        host: host,
                        validUntil: platform_1.default.Config.now() + client.options.timeouts.fallbackRetryTimeout,
                    };
                }
                return result;
            };
...
const XHRStates_1 = tslib_1.__importDefault(__webpack_require__(8266));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const HttpStatusCodes_1 = __webpack_require__(7234);
...
__webpack_unused_export__ = ({ value: true });
__webpack_unused_export__ = exports.defaultBundledRequestImplementations = void 0;
const tslib_1 = __webpack_require__(1635);
const xhrrequest_1 = tslib_1.__importDefault(__webpack_require__(4723));
const fetchrequest_1 = tslib_1.__importDefault(__webpack_require__(8557));
...
const tslib_1 = __webpack_require__(1635);
const xhrpollingtransport_1 = tslib_1.__importDefault(__webpack_require__(4575));
const websockettransport_1 = tslib_1.__importDefault(__webpack_require__(7760));
...
const tslib_1 = __webpack_require__(1635);
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const comettransport_1 = tslib_1.__importDefault(__webpack_require__(8745));
const xhrrequest_1 = tslib_1.__importDefault(__webpack_require__(4723));
const TransportName_1 = __webpack_require__(5868);
...
const tslib_1 = __webpack_require__(1635);
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const hmac_sha256_1 = __webpack_require__(6557);
class BufferUtils {
    constructor() {
    ...
    class Crypto {
        ...
        static async generateRandomKey(keyLength) {
            try {
                ...
                throw new errorinfo_1.default('Failed to generate random key: ' + err.message, 400, 50000);
            }
        }
        /**
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _nativescript_core_application_settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3219);
...
module.exports = __WEBPACK_EXTERNAL_MODULE__3219__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__6015__;
...
const tslib_1 = __webpack_require__(1635);
// Common
const defaultrest_1 = __webpack_require__(7117);
const defaultrealtime_1 = __webpack_require__(7966);
const platform_1 = tslib_1.__importDefault(__webpack_require__(869));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(9612));
const protocolmessage_1 = __webpack_require__(9809);
// Platform Specific
const bufferutils_1 = tslib_1.__importDefault(__webpack_require__(9563));
// @ts-ignore
const crypto_1 = __webpack_require__(6203);
const http_1 = tslib_1.__importDefault(__webpack_require__(7710));
// @ts-ignore
const config_1 = tslib_1.__importDefault(__webpack_require__(7701));
// @ts-ignore
const transport_1 = tslib_1.__importDefault(__webpack_require__(6477));
const logger_1 = tslib_1.__importDefault(__webpack_require__(4305));
const defaults_1 = __webpack_require__(4567);
// @ts-ignore
const webstorage_1 = tslib_1.__importDefault(__webpack_require__(3765));
const defaults_2 = tslib_1.__importDefault(__webpack_require__(6076));
const msgpack_1 = tslib_1.__importDefault(__webpack_require__(4828));
const request_1 = __webpack_require__(5730);
