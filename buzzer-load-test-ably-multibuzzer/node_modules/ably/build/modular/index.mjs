...
var ErrorInfo = class _ErrorInfo extends Error {
  constructor(messageOrValues, code, statusCode, cause, detail) {
    ...
    if (typeof messageOrValues === "object") {
      ...
      if (typeof values.message !== "string" || typeof values.code !== "number" || typeof values.statusCode !== "number" || !isNil(values.detail) && (typeof values.detail !== "object" || Array.isArray(values.detail))) {
...
var PartialErrorInfo = class _PartialErrorInfo extends Error {
  constructor(messageOrValues, code, statusCode, cause, detail) {
    ...
    if (typeof messageOrValues === "object") {
      const values = messageOrValues;
      if (typeof values.message !== "string" || !isNil(values.code) && typeof values.code !== "number" || !isNil(values.statusCode) && typeof values.statusCode !== "number" || !isNil(values.detail) && (typeof values.detail !== "object" || Array.isArray(values.detail))) {
...
function detectV1Callback(args, v2TrailingFnArity) {
  ...
  if (typeof args[n2 - 1] !== "function")
    return;
  if (n2 <= v2TrailingFnArity && typeof args[n2 - 2] !== "function")
    return;
  throw new ErrorInfo({
...
var BaseClient = class {
  ...
  device() {
    ...
    if (!this._device) {
      if ((_b = this.pushConfig) == null ? void 0 : _b.storageIsAsync) {
        throw new ErrorInfo({
...
var Push = class {
  ...
  async activate(registerCallback, updateFailedCallback) {
    ...
    if (!pushPlugin) {
      throw createMissingPluginError("Push");
    }
  ...
  async updateToken(token) {
    ...
    if (!token || token.transportType !== "fcm" && token.transportType !== "apns" || typeof token.token !== "string" || token.token.length === 0) {
      throw new ErrorInfo({
...
var LiveActivity = class {
  ...
  async start(params) {
    ...
    if (hasChannels === hasDeviceId) {
      throw new ErrorInfo("LiveActivity.start() requires exactly one of recipient.channels or recipient.deviceId", 4e4, 400);
    }
    const body = {
      apns
    };
...
var actions3 = ["message.create", "message.update", "message.delete", "meta", "message.summary", "message.append"];
...
var RestChannel = class {
  ...
  async _publish(requestBody, headers, params) {
    ...
    const {
      body,
      unpacked
    } = await resource_default.post(client, client.rest.channelMixin.basePath(this) + "/messages", requestBody, headers, params, null, true);
    const decoded = (unpacked ? body : decodeBody(body, client._MsgPack, format)) || {};
...
var RestChannelMixin = class {
  ...
  static async updateDeleteMessage(channel, action, message, operation, params) {
    ...
    const {
      body,
      unpacked
    } = await method(client, this.basePath(channel) + "/messages/" + encodeURIComponent(message.serial), requestBody, headers, params || {}, null, true);
    const decoded = unpacked ? body : decodeBody(body, client._MsgPack, format);
    return decoded || {
      versionSerial: null
    };
...
function serialFromMsgOrSerial(msgOrSerial, methodName) {
  ...
  if (!messageSerial || typeof messageSerial !== "string") {
    throw new ErrorInfo({
      message: "The message argument of annotations." + methodName + "() must be either a Message or other object carrying a non-empty string `serial` property, or a message serial as a non-empty string",
      code: 40003,
      statusCode: 400,
      remediation: "Pass the Message received from a subscribe callback (which carries .serial), or its serial string. Newly constructed Message objects do not have a serial."
    });
...
function constructValidateAnnotation(msgOrSerial, annotationValues, methodName) {
  ...
  if (!annotationValues || typeof annotationValues !== "object") {
    throw new ErrorInfo({
      ...
      code: 40003,
      statusCode: 400,
      remediation: 'Pass an Annotation-shaped object as the second argument, e.g. { type: "reaction:unique.v1", name: "\u{1F44D}" }.'
    });
  }
...
var RestAnnotations = class {
  ...
  async get(msgOrSerial, params) {
    const client = this.channel.client, messageSerial = serialFromMsgOrSerial(msgOrSerial, "get"), format = client.options.useBinaryProtocol ? "msgpack" /* msgpack */ : "json" /* json */, envelope = client.http.supportsLinkHeaders ? void 0 : format, headers = defaults_default.defaultGetHeaders(client.options);
    mixin(headers, client.options.headers);
...
var Config = {
  ...
  setTimeout: globalObject4.setTimeout.bind(globalObject4),
  clearTimeout: globalObject4.clearTimeout.bind(globalObject4),
  now: Date.now,
...
var PresenceMap = class extends eventemitter_default {
  ...
  startSync() {
    ...
    this.residualMembers = /* @__PURE__ */ Object.create(null);
...
var RealtimePresence = class extends eventemitter_default {
  ...
  setPresence(presenceSet, isSync, syncChannelSerial) {
    ...
    if (isSync) {
      ...
      if (!this.members.syncInProgress || this._syncId !== void 0 && syncId !== this._syncId) {
