...
exports.useObject = void 0;
const dequal_1 = require("dequal");
const react_1 = require("react");
const constants_js_1 = require("../hooks/constants.js");
const useChannelAttach_js_1 = require("../hooks/useChannelAttach.js");
const useChannelInstance_js_1 = require("../hooks/useChannelInstance.js");
const useStateErrors_js_1 = require("../hooks/useStateErrors.js");
...
function useObject(selectorOrOptions, maybeOptions) {
    var _a, _b;
    ...
    const { channel } = (0, useChannelInstance_js_1.useChannelInstance)(options.ablyId, options.channelName);
    const { connectionError, channelError } = (0, useStateErrors_js_1.useStateErrors)(options);
    const { connectionState } = (0, useChannelAttach_js_1.useChannelAttach)(channel, options.ablyId, skip);
    const [rootState, setRootState] = (0, react_1.useState)({ error: null });
    const rootStateRef = (0, react_1.useRef)(rootState);
    ...
    const canResolve = !skip && !constants_js_1.INACTIVE_CONNECTION_STATES.includes(connectionState);
    (0, react_1.useEffect)(() => {
        if (!canResolve) {
            return;
        }
    ...
    const store = (0, react_1.useMemo)(() => {
        ...
        return {
            subscribe: (onStoreChange) => {
                ...
                if (!(0, dequal_1.dequal)(latest, value)) {
                    value = latest;
                    onStoreChange();
                }
    ...
    const value = (0, react_1.useSyncExternalStore)(store.subscribe, store.getSnapshot, getServerSnapshot);
    return {
        value,
        object: node,
        error,
