...
/**
 * Resolves a game session join code (e.g. "G6D56U") into the flat list of
 * {sessionId, role, teamId, playerId, gameliveId} entries the load test
 * workers expect — mirroring GameSession.teams[].players[] + GameLive lookup
 * used by the backend's socket auth (see socket.middleware.ts).
 */
